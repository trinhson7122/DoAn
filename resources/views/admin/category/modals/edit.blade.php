    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Sửa phân loại</h5>
                ...
                <form action="{{ route('admin.category.update', $category->id) }}" method="post"
                    ...
                    <div>
                        ...
                        <div class="text-center pt-0 validate-avatar">
                            ...
                            <style>
                                #editCategoryModal .image-input-placeholder {
                                    background-image: url("{{ $category->getImage() }}");
                                }
                            </style>
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url({{ $category->getImage() }})"></div>
