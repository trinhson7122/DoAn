    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Sửa size</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.size.update', $size->id) }}" method="post">
                    ...
                    <div class="validate-name">
                        ...
                        <input type="text" class="form-control mb-2" name="name" value="{{ $size->name }}"
                            placeholder="L">
                    ...
                    <div class="validate-number">
                        ...
                        <input type="text" class="form-control mb-2" name="number" value="{{ $size->number }}"
                            placeholder="12-13">
                        <div class="text-danger feedback"></div>
                    </div>
                </form>
