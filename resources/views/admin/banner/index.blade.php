<x-admin.layout.home>
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base"
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Thêm banner
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <x-handle_ajax url="{{ route('admin.banner.index') }}" id="table_banner">
                                @include('admin.banner.table_list')
                            </x-handle_ajax>
                        </div>
                        <!--end::Table-->
                    </div>
    ...
    @include('admin.banner.modals.create')
</x-admin.layout.home>
