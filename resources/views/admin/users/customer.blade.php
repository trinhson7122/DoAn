<x-admin.layout.home>
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base"
                                ...
                                <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Thêm khách hàng
                                </button>
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <x-handle_ajax 
                                url="{{ route('admin.user.customer') }}"
                                search="#kt_app_content_container input[type=search]"
                                filter_id="#filter_user"
                                >
                                @include('admin.users.table_list_customer', $users)
                            </x-handle_ajax>
                        </div>
                        <!--end::Table-->
                    </div>
    ...
    @include('admin.users.modals.create_customer')
</x-admin.layout.home>
