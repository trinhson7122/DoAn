<div class="modal fade" id="createKindModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.kind.store') }}" method="post">
                    @csrf
    ...
    <script>
        $(() => {
            ...
            function clear() {
                ...
                form.find('[name="category_id"]')[0].selectedIndex = 0;
