<x-admin.layout.home>
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base"
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Thêm màu sắc
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <x-handle_ajax url="{{ route('admin.color.index') }}" id="table_color">
                                @include('admin.color.table_list', $colors)
                            </x-handle_ajax>
                        </div>
                        <!--end::Table-->
                    </div>
    ...
    @include('admin.color.modals.create', ['colors', $colors])
</x-admin.layout.home>
