                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base"
                                ...
                                <x-admin.filter :data="$filters" id="filter_order" />
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <x-handle_ajax url="{{ route('admin.order.index') }}"
                                search="#kt_app_content_container input[type=search]" filter_id="#filter_order"
                                id="table_order">
                                @include('admin.order.table_list')
                            </x-handle_ajax>
                        </div>
                        <!--end::Table-->
                    </div>
